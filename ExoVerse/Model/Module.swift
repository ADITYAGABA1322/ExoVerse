...
enum Module: String, Identifiable, CaseIterable, Equatable {
    ...
    var eyebrow: String {
        switch self {
        case .globe:
            return String(localized: "A Day in the Life", comment: "The subtitle of the Planet Earth module.")
        case .orbit:
            return String(localized: "Exploring Distant Worlds", comment: "The subtitle of the Orbit module.")
        case .solar:
            return String(localized: "Beyond Our Solar System", comment: "The subtitle of the Solar System module.")
        }
    }
    ...
    var heading: String {
        switch self {
        case .globe:
            return String(localized: "Planet Earth", comment: "The title of a module in the app.")
        case .orbit:
            return String(localized: "Exoplanets and Moons", comment: "The title of a module for orbit.")
        case .solar:
            return String(localized: "Exoplanets in Deep Space", comment: "The title of a module for solar system exploration beyond our solar system.")
        }
    }
    ...
    var abstract: String {
        switch self {
        case .globe:
            return String(localized: "A lot goes into making a day happen on Planet Earth! Discover how our globe turns and tilts to give us hot summer days, chilly autumn nights, and more.", comment: "Detail text explaining the Planet Earth module.")
        case .orbit:
            return String(localized: "Explore the fascinating orbits of exoplanets and the moons of our solar system, and learn how distant satellites circle other stars.", comment: "Detail text explaining the Orbit module.")
        case .solar:
            return String(localized: "Journey outside our solar system and dive into the mysteries of distant exoplanets, stars, and galaxies. Discover the vastness beyond Earth’s orbit.", comment: "Detail text explaining the Solar System module.")
        }
    }
    ...
    var overview: String {
        switch self {
        case .globe:
            return String(localized: "You can’t feel it, but Earth is constantly in motion. All planets spin on an invisible axis: ours makes one full turn every 24 hours, bringing days and nights to our home.\n\nWhen your part of the world faces the Sun, it’s daytime; when it rotates away, we move into night. When you see a sunrise or sunset, you’re witnessing the Earth in motion.\n\nWant to explore Earth’s rotation and axial tilt? Check out our interactive 3D globe and be hands-on with Earth’s movements.", comment: "Educational text displayed in the Planet Earth module.")
        case .orbit:
            return String(localized: "Distant exoplanets orbit their own stars just like Earth orbits the Sun. Some of these planets might even harbor moons or have their own satellites. Explore 3D objects representing various exoplanets and moons.", comment: "Overview text displayed in the Orbit module.")
        case .solar:
            return String(localized: "Exoplanets exist outside our solar system, often orbiting faraway stars. Dive deep into these mysterious planets, explore their characteristics, and discover how they differ from Earth and other planets in the solar system.", comment: "Overview text displayed in the Solar System module.")
        }
    }

    var callToAction: String {
        switch self {
        case .globe: return String(localized: "View Globe", comment: "An action the viewer can take in the Planet Earth module.")
        case .orbit: return String(localized: "View Orbits", comment: "An action the viewer can take in the Objects in Orbit module.")
        case .solar: return String(localized: "View Exoplanets", comment: "An action the viewer can take in the Exoplanets module.")
        }
    }

    static let funFacts = [
        String(localized: "The Earth orbits the Sun on an invisible path called the ecliptic plane.", comment: "An educational fact displayed in the Solar System module."),
        String(localized: "The first exoplanet was discovered in 1992 orbiting a pulsar.", comment: "An educational fact displayed in the Exoplanets module."),
        String(localized: "Exoplanets can range in size from smaller than Earth to much larger than Jupiter.", comment: "An educational fact displayed in the Exoplanets module."),
        String(localized: "Some exoplanets may have conditions favorable for life.", comment: "An educational fact displayed in the Exoplanets module.")
    ]
}
